...
class Images(models.Model):
    ...
    out_name1 = models.CharField(max_length=128, blank=True, null=True)
    out_name2 = models.CharField(max_length=128, blank=True, null=True)
    out_name3 = models.CharField(max_length=128, blank=True, null=True)
    out_name4 = models.CharField(max_length=128, blank=True, null=True)
    out_name5 = models.CharField(max_length=128, blank=True, null=True)